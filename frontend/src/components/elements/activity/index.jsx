...
const Activity = () => {
    const ArrayData = [
        {
            ...
            extendedDescription: '23 may tarixində Bakı Biznes Universitetində keçirilən karyera sərgisində Abşeron Logistika Mərkəzi olaraq biz də iştirak etdik. Stendimizə yaxınlaşan ziyarətçilərə əməkdaşlarımız tərəfindən Mərkəzin iş prinsipi, təcrübə və iş imkanları, həmçinin təqaüd proqramları haqqında ətraflı məlumat təqdim olundu. Tədbir zamanı universitetin rektoru İbad Abbasov da stendimizi ziyarət etdi və təqdimatımızla maraqlandı.'
        },
        {
            id: 1,
            ...
            extendedDescription: '2 May tarixində ADA Universitetində keçirilmiş karyera sərgisində Abşeron Logistika Mərkəzi də iştirak edib. Stendimizə yaxınlaşan ziyarətçilərə əməkdaşlarımız tərəfindən Mərkəzin iş prinsipi, təcrübə və iş imkanları, eləcə də təqaüd proqramları barədə ətraflı məlumat verilmişdir. Tədbirin yüksək səviyyədə təşkilinə görə ada.university -ə təşəkkür edirik.'
        },
        {
            id: 2,
        ...
        },
        {
            ...
            extendedDescription: '22 may tarixində Bakı Mühəndilik Univeristetində keçirilən CareerFest karyera sərgisində Abşeron Logistika Mərkəzi olaraq biz də iştirak edirik. Stendimizə yaxınlaşan ziyarətçilərə əməkdaşlarımız tərəfindən Mərkəzin iş prinsipi, təcrübə və iş imkanları, həmçinin təqaüd proqramları haqqında ətraflı məlumat təqdim olunur.'
        },
        {
            id: 4,
    ...
    // Hide asw-container when expandedCard is open
    useEffect(() => {
        ...
        if (aswContainer) {
            if (expandedCard) {
                ...
                aswContainer.style.display = ''; // Reset to default
            }
        }
    }, [expandedCard]);
